...
@Repository
public class RepairSurplusDao extends GenericDaoImpl<BasRepairSurplus, BasRepairSurplusId> {
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RepairSurplusDao.class);
