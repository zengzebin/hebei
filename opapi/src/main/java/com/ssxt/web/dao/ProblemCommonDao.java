...
@Repository
public class ProblemCommonDao extends GenericDaoImpl<BasProblemCommon, BasProblemCommonId> {
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ProblemCommonDao.class);
