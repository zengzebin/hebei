...
@Repository
public class DeviceOrderDetailsDao extends GenericDaoImpl<BasDeviceOrderDetails, Integer> {
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DeviceOrderDetailsDao.class);
