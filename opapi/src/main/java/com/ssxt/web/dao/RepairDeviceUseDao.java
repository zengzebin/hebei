...
@Repository
public class RepairDeviceUseDao extends GenericDaoImpl<BasRepairDeviceUse, Integer> {
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RepairDeviceUseDao.class);
