...
@Repository
public class WarningDao extends GenericDaoImpl<BasWarning, Integer> {
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(WarningDao.class);
