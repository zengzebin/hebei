...
@Repository
public class ClassRoomDao extends GenericDaoImpl<BasClassRoom, Integer> {
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ClassRoomDao.class);
