...
@Repository
public class ServerSituationDao extends GenericDaoImpl<BasServerSituation, Integer> {
	private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ServerSituationDao.class);
