...
/**
 * GwRainfallPptnR entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gw_rainfall_pptn_r", catalog = "hebei")
public class GwRainfallPptnR implements java.io.Serializable {

	// Fields

	private GwRainfallPptnRId id;
	private Double drp;
	private Double intv;
	private Double pdr;
	private Double dyp;
	...
	/** default constructor */
	public GwRainfallPptnR() {
	}

	/** minimal constructor */
	public GwRainfallPptnR(GwRainfallPptnRId id) {
		this.id = id;
	}

	/** full constructor */
	public GwRainfallPptnR(GwRainfallPptnRId id, Double drp, Double intv,
			Double pdr, Double dyp, String wth, String vt) {
		this.id = id;
		this.drp = drp;
		this.intv = intv;
		this.pdr = pdr;
	...
	public GwRainfallPptnRId getId() {
		return this.id;
	}

	public void setId(GwRainfallPptnRId id) {
		this.id = id;
	}
