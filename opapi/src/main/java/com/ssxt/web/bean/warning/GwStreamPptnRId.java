...
/**
 * GwStreamPptnRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwStreamPptnRId implements java.io.Serializable {
	...
	/** default constructor */
	public GwStreamPptnRId() {
	}

	/** full constructor */
	public GwStreamPptnRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwStreamPptnRId))
			return false;
		GwStreamPptnRId castOther = (GwStreamPptnRId) other;
