...
/**
 * GwTorrentialfloodInfo entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gw_torrentialflood_info", catalog = "hebei")
public class GwTorrentialfloodInfo implements java.io.Serializable {
	...
	/** default constructor */
	public GwTorrentialfloodInfo() {
	}

	/** minimal constructor */
	public GwTorrentialfloodInfo(String stcd) {
		this.stcd = stcd;
	}

	/** full constructor */
	public GwTorrentialfloodInfo(String stcd, Timestamp observationTime,
