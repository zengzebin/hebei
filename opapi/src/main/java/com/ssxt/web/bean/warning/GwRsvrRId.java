...
/**
 * GwRsvrRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwRsvrRId implements java.io.Serializable {
	...
	/** full constructor */
	public GwRsvrRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwRsvrRId))
			return false;
		GwRsvrRId castOther = (GwRsvrRId) other;
