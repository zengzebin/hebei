...
/**
 * GwRainfallRsvrR entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gw_rainfall__rsvr_r", catalog = "hebei")
public class GwRainfallRsvrR implements java.io.Serializable {

	// Fields

	private GwRainfallRsvrRId id;
	private Double rz;
	private Double inq;
	private Double w;
	private Double blrz;
	...
	/** default constructor */
	public GwRainfallRsvrR() {
	}

	/** minimal constructor */
	public GwRainfallRsvrR(GwRainfallRsvrRId id) {
		this.id = id;
	}

	/** full constructor */
	public GwRainfallRsvrR(GwRainfallRsvrRId id, Double rz, Double inq,
	...
	public GwRainfallRsvrRId getId() {
		return this.id;
	}

	public void setId(GwRainfallRsvrRId id) {
		this.id = id;
	}
