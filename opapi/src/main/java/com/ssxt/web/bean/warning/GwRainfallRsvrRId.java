...
/**
 * GwRainfallRsvrRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwRainfallRsvrRId implements java.io.Serializable {
	...
	/** default constructor */
	public GwRainfallRsvrRId() {
	}

	/** full constructor */
	public GwRainfallRsvrRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwRainfallRsvrRId))
			return false;
		GwRainfallRsvrRId castOther = (GwRainfallRsvrRId) other;
