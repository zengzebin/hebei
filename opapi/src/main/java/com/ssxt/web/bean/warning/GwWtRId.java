...
/**
 * GwWtRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwWtRId implements java.io.Serializable {
	...
	/** full constructor */
	public GwWtRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwWtRId))
			return false;
		GwWtRId castOther = (GwWtRId) other;
