...
/**
 * GwRiverRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwRiverRId implements java.io.Serializable {
	...
	/** full constructor */
	public GwRiverRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwRiverRId))
			return false;
		GwRiverRId castOther = (GwRiverRId) other;
