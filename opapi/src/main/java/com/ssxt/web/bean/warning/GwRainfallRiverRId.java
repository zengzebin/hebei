...
/**
 * GwRainfallRiverRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwRainfallRiverRId implements java.io.Serializable {
	...
	/** default constructor */
	public GwRainfallRiverRId() {
	}

	/** full constructor */
	public GwRainfallRiverRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwRainfallRiverRId))
			return false;
		GwRainfallRiverRId castOther = (GwRainfallRiverRId) other;
