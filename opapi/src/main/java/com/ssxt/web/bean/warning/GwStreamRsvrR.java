...
/**
 * GwStreamRsvrR entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gw_stream__rsvr_r", catalog = "hebei")
public class GwStreamRsvrR implements java.io.Serializable {

	// Fields

	private GwStreamRsvrRId id;
	private Double rz;
	private Double inq;
	private Double w;
	private Double blrz;
	...
	/** default constructor */
	public GwStreamRsvrR() {
	}

	/** minimal constructor */
	public GwStreamRsvrR(GwStreamRsvrRId id) {
		this.id = id;
	}

	/** full constructor */
	public GwStreamRsvrR(GwStreamRsvrRId id, Double rz, Double inq, Double w,
			Double blrz, Double otq, String rwchrcd, String rwptn,
			Double inqdr, String msqmt, String vt) {
		this.id = id;
		this.rz = rz;
		this.inq = inq;
		this.w = w;
	...
	public GwStreamRsvrRId getId() {
		return this.id;
	}

	public void setId(GwStreamRsvrRId id) {
		this.id = id;
	}
