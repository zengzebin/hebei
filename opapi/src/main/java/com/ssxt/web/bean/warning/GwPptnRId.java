...
/**
 * GwPptnRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwPptnRId implements java.io.Serializable {
	...
	/** full constructor */
	public GwPptnRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwPptnRId))
			return false;
		GwPptnRId castOther = (GwPptnRId) other;
