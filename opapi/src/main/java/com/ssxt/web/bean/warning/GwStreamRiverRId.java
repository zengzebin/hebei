...
/**
 * GwStreamRiverRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwStreamRiverRId implements java.io.Serializable {
	...
	/** default constructor */
	public GwStreamRiverRId() {
	}

	/** full constructor */
	public GwStreamRiverRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwStreamRiverRId))
			return false;
		GwStreamRiverRId castOther = (GwStreamRiverRId) other;
