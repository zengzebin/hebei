...
/**
 * GwRainfallRiverR entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gw_rainfall_river_r", catalog = "hebei")
public class GwRainfallRiverR implements java.io.Serializable {

	// Fields

	private GwRainfallRiverRId id;
	private Double z;
	private Double q;
	private Double xsa;
	...
	/** default constructor */
	public GwRainfallRiverR() {
	}

	/** minimal constructor */
	public GwRainfallRiverR(GwRainfallRiverRId id) {
		this.id = id;
	}

	/** full constructor */
	public GwRainfallRiverR(GwRainfallRiverRId id, Double z, Double q,
			Double xsa, Double xsavv, Double xsmxv, String flwchrcd,
			String wptn, String msqmt, String msamt, String msvmt, String vt) {
		this.id = id;
		this.z = z;
		this.q = q;
		this.xsa = xsa;
	...
	public GwRainfallRiverRId getId() {
		return this.id;
	}

	public void setId(GwRainfallRiverRId id) {
		this.id = id;
	}
