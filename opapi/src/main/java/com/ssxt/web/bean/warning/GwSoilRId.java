...
/**
 * GwSoilRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwSoilRId implements java.io.Serializable {
	...
	/** full constructor */
	public GwSoilRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwSoilRId))
			return false;
		GwSoilRId castOther = (GwSoilRId) other;
