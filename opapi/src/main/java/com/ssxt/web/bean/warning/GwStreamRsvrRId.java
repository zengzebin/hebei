...
/**
 * GwStreamRsvrRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwStreamRsvrRId implements java.io.Serializable {
	...
	/** default constructor */
	public GwStreamRsvrRId() {
	}

	/** full constructor */
	public GwStreamRsvrRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwStreamRsvrRId))
			return false;
		GwStreamRsvrRId castOther = (GwStreamRsvrRId) other;
