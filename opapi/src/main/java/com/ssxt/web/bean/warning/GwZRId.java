...
/**
 * GwZRId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class GwZRId implements java.io.Serializable {
	...
	/** full constructor */
	public GwZRId(String stcd, Timestamp tm) {
		this.stcd = stcd;
		this.tm = tm;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GwZRId))
			return false;
		GwZRId castOther = (GwZRId) other;
