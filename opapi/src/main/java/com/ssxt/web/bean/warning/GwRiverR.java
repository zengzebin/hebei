...
/**
 * GwRiverR entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gw_river_r", catalog = "hebei")
public class GwRiverR implements java.io.Serializable {

	// Fields

	private GwRiverRId id;
	private Double z;
	private Double q;
	private Double xsa;
	...
	/** minimal constructor */
	public GwRiverR(GwRiverRId id) {
		this.id = id;
	}

	/** full constructor */
	public GwRiverR(GwRiverRId id, Double z, Double q, Double xsa,
	...
	public GwRiverRId getId() {
		return this.id;
	}

	public void setId(GwRiverRId id) {
		this.id = id;
	}
