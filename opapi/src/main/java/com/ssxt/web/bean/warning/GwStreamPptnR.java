...
/**
 * GwStreamPptnR entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "gw_stream_pptn_r", catalog = "hebei")
public class GwStreamPptnR implements java.io.Serializable {

	// Fields

	private GwStreamPptnRId id;
	private Double drp;
	private Double intv;
	private Double pdr;
	private Double dyp;
	...
	/** default constructor */
	public GwStreamPptnR() {
	}

	/** minimal constructor */
	public GwStreamPptnR(GwStreamPptnRId id) {
		this.id = id;
	}

	/** full constructor */
	public GwStreamPptnR(GwStreamPptnRId id, Double drp, Double intv,
	...
	public GwStreamPptnRId getId() {
		return this.id;
	}

	public void setId(GwStreamPptnRId id) {
		this.id = id;
	}
