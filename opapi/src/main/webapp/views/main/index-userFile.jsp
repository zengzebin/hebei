...
function getProgress() {
    ...
    $.ajax({
        ...
        success: function(data) {
        	$("#progress_percent").text(50);
            $("#progress_bar").width((data.bytesRead/data.contentLength)*100);
            $("#has_upload").text(data.bytesRead);  
...
<div class="yxbox">
    ...
    <div class="pd15">
    	...
    	<p class="mb20"><input type="file"  name="file1" id="fileToUpload" title="请选择要上传的文件" onchange="fSubmit();"></p>
      
          	<p class="mb20"><input type="file"  name="file2" id="fileToUpload2" title="请选择要上传的文件" onchange="fSubmit();"></p>
